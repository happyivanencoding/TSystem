...
params_principal =  {
          ...
          'df_features_path': r"Input_files\screen_ML_EU.parquet",
          'df_features_backtest_path': r"Input_files\screen_ML_EU_backtest.parquet",
          'score_ml_path': r"Output_files\SCORE_ML_EU_production.parquet",
          'score_ml_backtest_path': r"Output_files\SCORE_ML_EU_backtest.parquet",
          'shap_path': r"Output_files\SCORE_ML_EU_production_SHAP.parquet",
          'shap_backtest_path': r"Output_files\SCORE_ML_EU_backtest_SHAP.parquet",
          'list_exclusion_path': r"Portfolio_BT\list_exclusion_EU.parquet",
          'univ': 'Univ ML EU'}
...
params_model = {'period_to_predict': [3.0, 6.0],
                ...
                'ranking_predict_to_score': 'homogenous_mean_and_rank', # rank_and_mean : First rank column then average, mean_and_rank : First average prediction columns then rank
...
params_hyper_parameters_xg_boost_PROD = {'subsample': 0.9,
                                        'reg_lambda': 0,
                                        'reg_alpha': 1,
                                        'n_estimators': 500,
                                        'min_child_weight': 5,
...
CONFIG = {"PARAMETRES PRINCICALES": params_principal,
          ...
          "HYPERPARAMETRES" : params_hyper_parameters_xg_boost_PROD
        }
