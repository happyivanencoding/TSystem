...
params_principal =  {
                    ...
                    'df_features_path': r"Input_files\screen_ML_OTHER.parquet",
                    'df_features_backtest_path': r"Input_files\screen_ML_OTHER_backtest.parquet",
                    'score_ml_path': r"Output_files\SCORE_ML_OTHER_production.parquet",
                    'score_ml_backtest_path': r"Output_files\SCORE_ML_OTHER_backtest.parquet",
                    'shap_path': r"Output_files\SCORE_ML_OTHER_production_SHAP.parquet",
                    'shap_backtest_path': r"Output_files\SCORE_ML_OTHER_backtest_SHAP.parquet",
                    'list_exclusion_path': r"Portfolio_BT\list_exclusion_OTHER.parquet",
                    'univ': 'Univ ML OTHER'}
