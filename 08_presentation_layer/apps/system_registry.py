...
PROJECT_REGISTRY: tuple[ProjectRegistryEntry, ...] = (
    ...
    ProjectRegistryEntry(
        ...
        commands=("python -m 03_ml_enhanced.cli inspect", "python -m 03_ml_enhanced.cli export-signals"),
        smoke_test="python -m 03_ml_enhanced.cli export-signals --output <tmp>",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.refresh_small_cap",),
        smoke_test="python -m 02_pipelines.refresh_small_cap --inspect-only",
