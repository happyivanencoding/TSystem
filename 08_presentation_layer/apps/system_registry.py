...
PROJECT_REGISTRY: tuple[ProjectRegistryEntry, ...] = (
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.refresh_data",),
        smoke_test="python -m 02_pipelines.refresh_data --inspect-only",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python -m pytest 01_tp_core",),
        smoke_test="validate_data_sources() + read_last_screen()",
        data_assets=(),
    ),
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.run_all",),
        smoke_test="python -m 02_pipelines.generate_report --step refresh_data",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python 03_ml_enhanced/export_signals.py",),
        smoke_test="python 03_ml_enhanced/export_signals.py --output <tmp>",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python 03_regime_model/export_risk_budget.py",),
        smoke_test="python 03_regime_model/export_risk_budget.py --output <tmp>",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python 03_technical_analysis/export_technical_signals.py",),
        smoke_test="python 03_technical_analysis/export_technical_signals.py --output <tmp>",
    ...
    ProjectRegistryEntry(
        ...
        inputs=("ML signals", "technical signals", "regime risk budget"),
        outputs=("ml_signals", "technical_signals", "regime_risk_budget"),
        commands=("python -m 02_pipelines.export_signals",),
        smoke_test="python -m 01_tp_core.signals 04_signals/ml_signals.parquet",
        data_assets=("ml_signals", "technical_signals", "regime_risk_budget"),
        manifest_required=True,
        pipeline_step="export_signals",
    ),
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.build_candidates",),
        smoke_test="python -m 02_pipelines.build_candidates --output <tmp>",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.optimize_portfolio",),
        smoke_test="python -m 02_pipelines.optimize_portfolio --output <tmp>",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.run_backtest", "python 07_backtest_code/run_backtest.py inspect"),
        smoke_test="python 07_backtest_code/run_backtest.py inspect",
    ...
    ProjectRegistryEntry(
        ...
        role="Dash 公司展示 app",
        root_path=TP_ROOT / "08_web_app_des_companies",
    ...
    ProjectRegistryEntry(
        ...
        role="公司分析 FastAPI",
        root_path=TP_ROOT / "08_company_analysis",
        inputs=("screen_aggregate",),
    ...
    ProjectRegistryEntry(
        ...
        role="组合 dashboard / PDF wrapper",
        root_path=TP_ROOT / "08_dashboard_analysis",
    ...
    ProjectRegistryEntry(
        ...
        commands=("python -m 02_pipelines.generate_report",),
    ...
    ProjectRegistryEntry(
        ...
        role="小盘研究扩展",
        root_path=TP_ROOT / "12_small_cap",
        inputs=("screen_aggregate", "returns"),
...
DATA_ASSET_REGISTRY: tuple[DataAssetEntry, ...] = (
    ...
    DataAssetEntry("12_small_cap", "small_cap_readme", TP_ROOT / "12_small_cap" / "README.md", "markdown", required=False),
)
