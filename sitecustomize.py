...
def _alias(logical_name: str, numbered_name: str) -> None:
    if logical_name in sys.modules:
        return
    try:
        sys.modules[logical_name] = importlib.import_module(numbered_name)
    except ModuleNotFoundError:
        return


_alias("tp_core", "01_tp_core")
_alias("optimiser", "06_optimiser")
_alias("presentation_layer", "08_presentation_layer")
