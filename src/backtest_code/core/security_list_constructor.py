...
from backtest_code.utils.data_utils import merge_ticker_secondaire, read_liste_noire, update_ptf_with_monthly_additions, find_next_closest_date
...
class SecurityListConstructor:
    ...
    def build_monthly_security_list(
        ...
        from backtest_code.portfolio.monthly_security_list import (
