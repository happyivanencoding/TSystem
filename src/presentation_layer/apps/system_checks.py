...
def project_checks() -> list[ProjectCheck]:
    ...
    return [
        ProjectCheck(
            ...
            [py, "-m", "tp_pipelines.refresh_data", "--inspect-only", "--run-type", "inspect"],
            data_kind="database",
        ),
        ProjectCheck(
        ...
        ProjectCheck(
            ...
            [
                py,
                "-m",
                "tp_models.regime.export_risk_budget",
                "--output",
        ...
        ProjectCheck(
            ...
            [
                ...
                (
                    ...
                    "from tp_models import country as m; "
