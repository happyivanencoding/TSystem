...
from presentation_layer.company_browser.data.index_screen_repository import get_index_screen_repository
from presentation_layer.company_browser.data.ptf_column_groups import (
...
from presentation_layer.company_browser.data.ptf_repository import get_ptf_repository
from presentation_layer.company_browser.services.ptf_table import attach_ptf_weight_to_ciq
from presentation_layer.company_browser.data.repository import get_repository
from presentation_layer.company_browser.ui.components.description_panel import render_description_panel
from presentation_layer.company_browser.ui.components.news_timeline import render_news_timeline

from presentation_layer.company_browser.callbacks.index_composition import (  # réutilise constantes + figures pairs
    _fmt as _fmt_date,
    _round2,
    _weight_to_pct2,
...
from presentation_layer.company_browser.services.drawer_figure_cache import (
    get_ind_factor_dict,
    set_ind_factor,
)
