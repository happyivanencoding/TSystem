...
from tp_backtest.config.loader import load_settings
from tp_backtest.config.settings import AppSettings
from tp_backtest.runner.service import BacktestService
from tp_backtest.runner.validators import inspect_file_pair
...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_common(subparser: argparse.ArgumentParser) -> None:
        subparser.add_argument("--profile", default="default", help="config/backtest 下的 YAML profile 名称")
