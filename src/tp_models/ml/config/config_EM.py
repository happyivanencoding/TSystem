...
params_principal =  {
                    ...
                    # MSCI EM 在该日期之后才进入连续月频，避免早期季频权重触发日期校验。
                    'screen_start_date': "2017-07-31",
                    'df_features_path': r"Input_files\screen_ML_EM.parquet",
                    'df_features_backtest_path': r"Input_files\screen_ML_EM_backtest.parquet",
                    'score_ml_path': r"Output_files\SCORE_ML_EM_production.parquet",
                    'score_ml_backtest_path': r"Output_files\SCORE_ML_EM_backtest.parquet",
                    'shap_path': r"Output_files\SCORE_ML_EM_production_SHAP.parquet",
                    'shap_backtest_path': r"Output_files\SCORE_ML_EM_backtest_SHAP.parquet",
                    'list_exclusion_path': r"Portfolio_BT\list_exclusion_EM.parquet",
                    'univ': 'MSCI EM'}
