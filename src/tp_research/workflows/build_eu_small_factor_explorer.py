...
import pandas as pd
from tp_reporting import render_inline_fragment
...
STANDALONE = REPORTS_DIR / "eu-small-factor-explorer.html"
PERIODS = [
...
def write_standalone() -> None:
    document = render_inline_fragment(FRAGMENT, "MSCI Europe Small Factor Explorer")
